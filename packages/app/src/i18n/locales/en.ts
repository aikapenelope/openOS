 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, AikaOS) are NOT translated
 */
...
export default {
  ...
  "dashboard.hero_description": "Describe an outcome. AikaOS will run it and keep an audit trail.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Save an AikaOS server as a worker.",
  "dashboard.create_remote_workspace_confirm": "Add Worker",
  "dashboard.edit_remote_workspace_title": "Edit Remote Connection",
  "dashboard.edit_remote_workspace_subtitle": "Update the AikaOS server details for this worker.",
  "dashboard.edit_remote_workspace_confirm": "Save connection",
  "dashboard.remote_workspace_title": "Remote worker",
  "dashboard.remote_workspace_hint": "Track an AikaOS server and reconnect anytime.",
  ...
  "dashboard.remote_mode_openwork_alpha": "AikaOS server",
  ...
  "session.placeholder": "Ask AikaOS...",
  "session.run": "Run",
  ...
  "skills.host_only_error": "Skill management requires a local worker or connected AikaOS server.",
  ...
  "skills.connect_host_to_load": "Connect an AikaOS server to load skills.",
  ...
  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "Apps",
  "mcp.apps_subtitle": "Connect your favorite tools so AikaOS can use them on your behalf.",
  ...
  "mcp.mcps_title": "Apps",
  "mcp.connect_mcp_hint": "Connect apps to expand what AikaOS can do.",
  ...
  "mcp.mcps_label": "Apps",
  "mcp.mcps_description": "Connect apps to expand what AikaOS can do.",
  ...
  "mcp.auth.step2_title": "Authorize AikaOS",
  ...
  "settings.updates_description": "Keep AikaOS up to date.",
  ...
  "settings.advanced_description": "Reset AikaOS local state to retest onboarding.",
  "settings.reset_onboarding": "Reset onboarding",
  "settings.reset_onboarding_description": "Clears AikaOS preferences and restarts the app.",
  "settings.reset_app_data": "Reset app data",
  "settings.reset_app_data_description": "More aggressive. Clears AikaOS cache + app data.",
  ...
  "settings.reset_confirmation_hint": "Type <span class=\"font-mono\">RESET</span> to confirm. AikaOS will restart.",
  "settings.reset_onboarding_warning": "Clears AikaOS local preferences and worker onboarding markers.",
  "settings.reset_app_data_warning": "Clears AikaOS cache and app data on this device.",
  ...
  "settings.updates_hint": "Keep AikaOS up to date.",
  ...
  "settings.advanced_hint": "Reset AikaOS local state to retest onboarding.",
  "settings.reset_onboarding_label": "Reset onboarding",
  "settings.reset_onboarding_hint": "Clears AikaOS preferences and restarts the app.",
  "settings.reset_app_data_label": "Reset app data",
  "settings.reset_app_data_hint": "More aggressive. Clears AikaOS cache + app data.",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "Starting AikaOS server...",
  "onboarding.searching_host": "Connecting to AikaOS server...",
  ...
  "onboarding.windows_install_instruction": "Install OpenCode for Windows, then restart AikaOS. Ensure opencode.exe is on PATH.",
  ...
  "onboarding.cli_install_commands": "Install OpenCode with one of the commands below, then restart AikaOS.",
  ...
  "onboarding.remote_workspace_title": "Connect to AikaOS server",
  "onboarding.remote_workspace_description": "Connect to an AikaOS server to access a worker from anywhere.",
  "onboarding.remote_workspace_action": "Connect",
  "onboarding.remote_workspace_card_title": "Connect a remote worker",
  "onboarding.remote_workspace_card_description": "Connect to an AikaOS server to access a shared worker.",
  "onboarding.advanced_openwork_host": "AikaOS server",
  ...
  "onboarding.welcome_title": "How would you like to run AikaOS today?",
  "onboarding.run_local": "Run locally",
  "onboarding.run_local_description": "AikaOS runs OpenCode locally and keeps your work private.",
  ...
  "app.migration.restart_failed": "Migration completed, but AikaOS could not restart the local engine.",
  ...
  "templates.title": "Apply Template",
  "templates.subtitle": "Install industry skills and commands into your worker.",
  "templates.filter_all": "All",
  "templates.filter_industry": "Industry",
  "templates.filter_function": "Function",
  "templates.install_button": "Install Template",
  "templates.installing": "Installing…",
  "templates.installed_success": "Template installed successfully!",
  "templates.commands_installed": "commands installed",
  "templates.suggested_mcps_hint": "Check the Extensions tab for suggested MCP servers.",
  "templates.install_error": "Installation failed",
} as const;
