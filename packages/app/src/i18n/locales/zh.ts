/**
 * 中文（简体）翻译
 * 专业术语不翻译：Skills、Plugins、Commands、Sessions、OpenCode、OpenPackage、AikaOS、MCPs
 */
...
export default {
  ...
  "dashboard.hero_description": "描述一个目标。AikaOS 将运行它并保留审计记录。",
  ...
  "dashboard.remote_mode_openwork_alpha": "AikaOS 服务器",
  ...
  "session.placeholder": "向 AikaOS 提问...",
  "session.run": "运行",
  ...
  "skills.host_only_error": "技能管理需要本地工作区或已连接的 AikaOS 服务器。",
  ...
  "skills.connect_host_to_load": "连接 AikaOS 服务器以加载技能。",
  ...
  "mcp.mcps_title": "MCPs",
  "mcp.connect_mcp_hint": "连接 MCP 服务器以扩展 AikaOS 的功能。",
  ...
  "mcp.mcps_label": "MCPs",
  "mcp.mcps_description": "连接 MCP 服务器以扩展 AikaOS 的功能。",
  "mcp.configured": "已配置",
  "mcp.updated": "更新时间",
  ...
  "mcp.auth.step2_title": "授权 AikaOS",
  ...
  "settings.done": "完成",
  "settings.updates": "更新",
  "settings.updates_description": "保持 AikaOS 为最新版本。",
  ...
  "settings.advanced_description": "重置 AikaOS 本地状态以重新测试入门流程。",
  ...
  "settings.reset_confirmation_hint": "输入 <span class=\"font-mono\">RESET</span> 以确认。AikaOS 将重启。",
  "settings.reset_onboarding_warning": "清除 AikaOS 本地偏好设置和工作区入门标记。",
  "settings.reset_app_data_warning": "清除此设备上的 AikaOS 缓存和应用数据。",
  ...
  "settings.updates_hint": "保持 AikaOS 为最新版本。",
  ...
  "settings.advanced_hint": "重置 AikaOS 本地状态以重新测试入门流程。",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "正在启动 AikaOS 服务器...",
  "onboarding.searching_host": "正在连接 AikaOS 服务器...",
  ...
  "onboarding.windows_install_instruction": "安装 Windows 版 OpenCode，然后重启 AikaOS。确保 opencode.exe 在 PATH 中。",
  ...
  "onboarding.cli_install_commands": "使用以下命令之一安装 OpenCode，然后重启 AikaOS。",
  ...
  "onboarding.remote_workspace_title": "连接 AikaOS 服务器",
  "onboarding.remote_workspace_description": "连接 AikaOS 服务器以随时访问工作区。",
  "onboarding.remote_workspace_action": "连接",
  "onboarding.remote_workspace_card_title": "连接远程工作区",
  "onboarding.remote_workspace_card_description": "连接 AikaOS 服务器以访问共享工作区。",
  "onboarding.advanced_openwork_host": "AikaOS 服务器",
  ...
  "onboarding.welcome_title": "今天想如何运行 AikaOS？",
  "onboarding.run_local": "本地运行",
  "onboarding.run_local_description": "AikaOS 在本地运行 OpenCode 并保持您的工作私密。",
  ...
  "onboarding.default_workspace_path": "~/AikaOS/Workspace",
  ...
  "app.migration.restart_failed": "迁移已完成，但 AikaOS 无法重启本地引擎。",
  ...
  "templates.title": "应用模板",
  "templates.subtitle": "将行业技能和命令安装到你的工作区。",
  "templates.filter_all": "全部",
  "templates.filter_industry": "行业",
  "templates.filter_function": "功能",
  "templates.install_button": "安装模板",
  "templates.installing": "安装中…",
  "templates.installed_success": "模板安装成功！",
  "templates.commands_installed": "个命令已安装",
  "templates.suggested_mcps_hint": "请查看扩展选项卡中推荐的 MCP 服务器。",
  "templates.install_error": "安装失败",
} as const;
